...
137 IF B=Y GOTO 280
139 PRINTAT(B*32+A),"O";:PRINTAT(0),"PONT:";P
140 IF KEY(27):GOTO240
150 IF KEY(28):GOTO260
160 IF KEY(29):GOTO200
170 IF KEY(30):GOTO220
180 GOTO 140
200 PRINTAT(B*32+A)," ":IF A>0 A=A-1
210 GOTO 135
220 PRINTAT(B*32+A)," ":IF A<31 A=A+1
230 GOTO 135
240 PRINTAT(B*32+A)," ":IF B>1 B=B-1
250 GOTO 135
260 PRINTAT(B*32+A)," ":IF B<14 B=B+1
270 GOTO 135
280 P=P+1:GOTO120